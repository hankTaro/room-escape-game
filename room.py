...
living_room_image = pygame.image.load(f"image/Room/living_room.png")
bedroom_image = pygame.image.load(f"image/Room/bedroom.png")
...
class LivingRoom:
    def __init__(self):
        # data
        # 房間背景
        self.bg_image = pygame.transform.scale(living_room_image, (GAME_WIDTH, GAME_HEIGHT))
        ...
        # 牆面3有這些東西
        self.__object_3 = [RightButton(WIN_WIDTH - 50,WIN_HEIGHT/2),LeftButton(20,WIN_HEIGHT/2),DoorToBedroom(200, 300), Tv(420, 400)]
        # 牆面4有這些東西
        self.__object_4 = [RightButton(WIN_WIDTH - 50,WIN_HEIGHT/2),LeftButton(20,WIN_HEIGHT/2),MenuButton(900, 50), Tv(420, 400)]
...
class Study:
    def __init__(self):
        # data
        # 房間背景
        self.bg_image = pygame.transform.scale(BACKGROUND_IMAGE, (GAME_WIDTH, GAME_HEIGHT))
        ...
        # 此房間在不同牆面有的物品/座標
        # 牆面1有這些東西
        self.__object_1 = [MenuButton(255, 245), Tv(420, 400)]
        # 牆面2有這些東西
        self.__object_2 = [MenuButton(255, 245), Tv(420, 400)]
        # 牆面3有這些東西
        self.__object_3 = [MenuButton(255, 245), Tv(420, 400)]
        # 牆面4有這些東西
        self.__object_4 = [MenuButton(255, 245), Tv(420, 400)]
...
class Bedroom:
    def __init__(self):
        # data
        # 房間背景
        self.bg_image = pygame.transform.scale(bedroom_image, (GAME_WIDTH, GAME_HEIGHT))
