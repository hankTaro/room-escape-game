...
class LivingRoom:
    def __init__(self):
        ...
        # 牆面3有這些東西
        self.__object_3 = [RightButton(WIN_WIDTH - 50,WIN_HEIGHT/2),LeftButton(20,WIN_HEIGHT/2),DoorToBedroom(200, 300)]
        # 牆面4有這些東西
        self.__object_4 = [RightButton(WIN_WIDTH - 50,WIN_HEIGHT/2),LeftButton(20,WIN_HEIGHT/2),MenuButton(900, 50)]
